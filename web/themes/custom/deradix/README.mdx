...
deradix theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of deradix theme and run the following commands:
`nvm use`
...
`drush en deradix -y`
`drush config-set system.theme default deradix -y`
